class AdvancesManager {
    ...
    editAdvance(advance_info, res) {
      ...
      this.db_connection.query("SELECT * FROM ADVANCE WHERE Advance_Id = " + advance_id, (err, result, fields) => {
        if (err) { throw err
          ...
          const insertion_query = "REPLACE INTO ADVANCE (Advance_Id, Activity_Id, User_Id, Advance_Comments, Initial_Time, Final_Time) VALUES (" + advance_id +", " + activity_id + ", " + user_id + ", '" + advance_comments +"', " + advance_initial_hour + ", " + advance_final_hour + "))";
    ...
    createAdvance(advance_info, res) {
        ...
        const insertion_query = "INSERT INTO ADVANCE (Activity_Id, User_id, Advance_Comments,  Initial_Time, Final_Time) VALUES (" + activity_id + ", " + user_id + ", '" + advance_comments + "', " + advance_initial_hour + ", " + advance_final_hour + "))";
        this.db_connection.query(insertion_query, function (err, result, fields) {
            if (err) throw err
